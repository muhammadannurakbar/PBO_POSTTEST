...
class Peminjaman {
    ...
    public Peminjaman(int id, String namaUMKM, long jumlahPinjaman, String tanggalPinjaman) {
        ...
        this.bungaPinjaman = 0.05; // 5% default
    }

    // Overloaded constructor with bunga parameter
    ...
    // Overloadable method: menghitung total yang harus dibayar
    public long hitungTotalPembayaran() {
        return jumlahPinjaman + (long)(jumlahPinjaman * bungaPinjaman);
    }
    
    // Overloadable method: menghitung total dengan periode tertentu
    public long hitungTotalPembayaran(int periodeWaktu) {
        return jumlahPinjaman + (long)(jumlahPinjaman * bungaPinjaman * periodeWaktu);
    }
    ...
    protected String formatRupiah(long amount) {
...
class PeminjamanModalKerja extends Peminjaman {
    ...
    public PeminjamanModalKerja(int id, String namaUMKM, long jumlahPinjaman, String tanggalPinjaman, String kebutuhanModal) {
        ...
        // Set bunga yang berbeda untuk modal kerja
        setBungaPinjaman(0.03); // 3% untuk modal kerja
    }
    
    // Overloaded constructor dengan bunga kustom
    ...
    // Override method menghitung total pembayaran untuk modal kerja
    @Override
    public long hitungTotalPembayaran() {
        // Modal kerja memiliki formula pembayaran berbeda
        return super.getJumlahPinjaman() + (long)(super.getJumlahPinjaman() * getBungaPinjaman() * 1.1); // 10% tambahan
    }
...
class PeminjamanInvestasi extends Peminjaman {
    ...
    private int durasiInvestasi; // dalam bulan
    ...
    public PeminjamanInvestasi(int id, String namaUMKM, long jumlahPinjaman, String tanggalPinjaman, String jenisInvestasi, int durasiInvestasi) {
        ...
        // Set bunga yang berbeda untuk investasi
        setBungaPinjaman(0.07); // 7% untuk investasi
    }
    ...
    // Override method untuk menghitung total pembayaran investasi
    @Override
    public long hitungTotalPembayaran() {
        // Investasi menggunakan durasi untuk perhitungan
        return super.getJumlahPinjaman() + (long)(super.getJumlahPinjaman() * getBungaPinjaman() * durasiInvestasi);
    }
    
    // Overloaded method untuk menghitung dengan parameter tambahan
...
public class SistemPeminjamanUMKM {
    ...
    private static void updatePeminjaman() {
        ...
        // Update additional info based on peminjaman type
    ...
    private static void lihatDetailPeminjaman() {
        ...
        peminjaman.displayDetailInfo(); // Method polymorphism (override)
    }
    ...
    private static void simulasiPembayaran() {
        ...
        // Method polymorphism (overloading)
        ...
        // Khusus investasi - tambahan simulasi
